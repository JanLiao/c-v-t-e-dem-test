...
public class TabsDemo extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        //scene.getStylesheets().add(TabsDemo.class.getResource("jfx-tab-pane.css").toExternalForm());

        scene.getStylesheets().add(LabelDemo.class.getResource("jfoenix-components.css").toExternalForm());
