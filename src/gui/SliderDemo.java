...
public class SliderDemo extends Application {
    ...
    public void start(Stage stage) {
        ...
        scene.getStylesheets().add(SliderDemo.class.getResource("jfoenix-components.css").toExternalForm());
