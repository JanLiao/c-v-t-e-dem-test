...
public class ProgressBarDemo extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        JFXProgressBar jfxBarInf1 = new JFXProgressBar();
        jfxBarInf1.setPrefWidth(500);
        jfxBarInf1.setProgress(-0.1f);
        jfxBarInf1.setTooltip(new Tooltip("sfds"));
        ...
        pane.getChildren().addAll(bar, jfxBar, cssBar, jfxBarInf, jfxBarInf1);
