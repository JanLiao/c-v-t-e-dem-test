...
public class DatePickerDemo extends Application {
    ...
    public void start(Stage stage) {
        ...
        //datePickerFX.setDefaultColor(Color.valueOf("#3f51b5"));
        //datePickerFX.setOverLay(true);
        main.getChildren().add(datePickerFX);
        datePickerFX.setPromptText("pick a date");
        datePickerFX.getEditor().setEditable(false);
        if(datePickerFX.isShowing()) {
        	System.out.println(666);
        }
        else {
        	System.out.println(777);
        }
        System.out.println(datePickerFX.isOverLay());
        ...
        //stylesheets.addAll(MainDemo.class.getResource("jfoenix-fonts.css").toExternalForm(),
                           //MainDemo.class.getResource("jfoenix-design.css").toExternalForm());
