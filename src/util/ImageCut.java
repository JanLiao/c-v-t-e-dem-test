...
public class ImageCut {
	...
	public static void main(String[] args) throws IOException {
		...
		int[] rgb = new int[3];
		BufferedImage imgIO = ImageIO.read(files[k]);
		...
		String savePath = "C:/Users/CVTE/Desktop/img_cut/6.jpg";
		FileOutputStream fos = new FileOutputStream(new File(savePath));
		ImageIO.write(imgIO, "jpg", new File("C:/Users/CVTE/Desktop/2k.jpg"));
		fos.flush();
		fos.close();
	}
