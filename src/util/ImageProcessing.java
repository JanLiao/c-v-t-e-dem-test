...
//        fileFormat=in.next();//读入文件格式
    	...
    	directory = "C:\\Users\\CVTE\\Desktop\\新建文件夹 (2)";
    	filename = "王美娜_20170718101028786";
    	fileFormat = "jpg";
    	ma = 0;
    	mi = 6;
...
//        ma=in.nextInt();
    ...
    public static void histogramEqualization() throws InterruptedException, IOException
    {
        //PixelGrabber pg=new PixelGrabber(tmp, 0, 0, iwidth, iheight, pixels,0,iwidth);
        //pg.grabPixels();
        BufferedImage greyImage=new BufferedImage(iwidth, iheight, BufferedImage.TYPE_INT_RGB);
