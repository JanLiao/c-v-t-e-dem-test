...
//		File f = new File("E:\\第一批\\非青光眼图片\\19487\\RRRR.jpg");
...
//			e.printStackTrace();
//		}
//		BufferedImage iIO = ImageCut.imgCut(imgIO, "");
//		
//		BufferedImage tpimgm = flipImage(iIO);
//		RepaintUtil.writePic(tpimgm, "E:\\第一批处理2\\非青光眼图片\\n0070.jpg");
